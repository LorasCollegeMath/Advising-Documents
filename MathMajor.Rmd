...
locations<-matrix(c( 0.25, 0.25,   0.75, 0.3,   0.15, 0.5,   0, 0.75,
                     1.25, 1,   0.45, 1.25,   0.65, 1.05,    1, 1.15,
                     1.35, 1.7,   0.85, 1.65,    0.25, 1.75,   0.45, 2.2,
...
class_schedule <- data_frame(Code = c("MAT 150", "MAT 160", "CIT 115", "PHY 223",
                       ...
                       "Fall", "Odd Springs", "Odd Falls", "Every",
                       "Even Falls", "Even Falls", "Odd Falls", "Spring",
                       "Every")
                       )
                       
class_schedule %>% filter(Semester != "Every") %>% slice(1:6) %>%  knitr::kable()
...
```{r When2, results="asis"}
class_schedule %>% filter(Semester != "Every") %>% slice(7:n()) %>%  knitr::kable()
